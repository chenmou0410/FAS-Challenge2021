...
from dataset.HiFi import HiFi_md,HiFi_md_val,HiFi_mutlimodal_src, HiFi_val
...
class cvt_trainer():
    ...
    def init_dataset(self):
        ...
        # train_dataset = HiFi_md(self.root_dir, self.data_list, transform=transform)
        train_dataset = HiFi_mutlimodal_src(self.root_dir, self.data_list, transform=transform)
        ...
        valid_dataset = HiFi_val(self.root_dir, self.val_list, transform=transform_val)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='/mnt/Data2/chenmou/FAS/HiFiMask-Challenge/phase1/', help='train data root')
    parser.add_argument('--train_list', type=str, default='/mnt/Data2/chenmou/FAS/HiFiMask-Challenge/phase1/train_label_clean.txt', help='train list file')
    parser.add_argument('--val_root', type=str, default='/mnt/Data2/chenmou/FAS/HiFiMask-Challenge/phase1/', help='val data root')
    parser.add_argument('--val_list', type=str, default='/mnt/Data2/chenmou/FAS/HiFiMask-Challenge/phase1/val_label.txt', help='val list file ')

    parser.add_argument('--ckpt_path', type=str, default='/home/chenmou/CVT/models/mutli_modal2/', help='checkpoint path')
